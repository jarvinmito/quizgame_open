...
this["App"]["Templates"]["options"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"ingame__options ingame__options--open\">\r\n<div class=\"open-ended\">\r\n<!--<div class=\"open-ended is-correct \">-->\r\n  <span class=\"open-ended__answer \"></span>\r\n  <input class=\"open-ended__textbox\" id=\"player__answer\" type=\"text\" />\r\n</div>\r\n	<button class=\"game-button game-button--ttclear game-button--light-blue\" type=\"button\">CLEAR</button>\r\n	<button class=\"game-button game-button--ttpass game-button--yellow\" type=\"button\">PASS</button>\r\n	<button class=\"game-button game-button--ttsubmit game-button--blue-green\" type=\"button\">SUBMIT</button>\r\n</div>";
},"useData":true});
...
this["App"]["Templates"]["question"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"ingame__question\">\r\n	<h1 class=\"question question--long\">"
    + ((stack1 = (helpers.stripSlashes || (depth0 && depth0.stripSlashes) || helpers.helperMissing).call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.question : stack1),{"name":"stripSlashes","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</h1>\r\n</div>";
},"useData":true});
...
this["App"]["Templates"]["results-buttons"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || helpers.helperMissing).call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.type : depth0),"parag",{"name":"ifCond","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data) {
    var alias1=container.lambda, alias2=container.escapeExpression;

  return "			<p class=\""
    + alias2(alias1((depth0 != null ? depth0.pclass : depth0), depth0))
    + "\">"
    + alias2(alias1((depth0 != null ? depth0.caption : depth0), depth0))
    + "</p>\r\n";
},"4":function(container,depth0,helpers,partials,data) {
...
this["App"]["Templates"]["results"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.opponent : stack1)) != null ? stack1.icon : stack1), depth0));
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : {}, alias4=helpers.helperMissing;
  ...
  return "<div class=\"result-page result-page--parent result-page--"
    ...
    + "\" >\r\n    <img class=\"main-player__avatar image--hasfallback\" src=\""
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias4).call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.me : stack1)) != null ? stack1.icon : stack1),"",{"name":"ifCond","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "\" alt=\""
    ...
    + " POINTS</span>\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"result-page__opponent opponent\">\r\n    <div class=\"opponent__text\">\r\n      <p>OPPONENT</p>\r\n      <p>DETAILS</p>\r\n    </div>\r\n    <div  class=\"opponent__avatar\">\r\n      <img class=\"image--hasfallback\" src=\""
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias4).call(alias3,((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.opponent : stack1)) != null ? stack1.icon : stack1),"",{"name":"ifCond","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    + "\" alt=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.me : stack1)) != null ? stack1.name : stack1), depth0))
...
this["App"]["Templates"]["versus"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.left : stack1)) != null ? stack1.icon : stack1), depth0));
},"5":function(container,depth0,helpers,partials,data) {
    var stack1;

  return container.escapeExpression(container.lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.right : stack1)) != null ? stack1.icon : stack1), depth0));
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"versus\">\r\n  <div class=\"versus__vs animate--in\">VS</div>\r\n  <div class=\"versus__one player--one animate--in\">\r\n   \r\n      <img class=\"player__avatar player__avatar--left image--hasfallback\" src=\""
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias2).call(alias1,((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.left : stack1)) != null ? stack1.icon : stack1),"",{"name":"ifCond","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "\" alt=\"\">\r\n      <div class=\"player__details\">\r\n        <div class=\"player__name\"><b>"
    + alias4(alias3(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.left : stack1)) != null ? stack1.name : stack1), depth0))
    + "</b></div>\r\n        <div class=\"player__badge\"><small>"
    + alias4(alias3(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.left : stack1)) != null ? stack1.badge : stack1), depth0))
    + "</small></div>\r\n        <div class=\"player__score\"></div>\r\n      </div>\r\n    \r\n  </div>\r\n\r\n  <div class=\"versus__two player--two animate--in\">\r\n    \r\n      <img class=\"player__avatar player__avatar--right image--hasfallback\" src=\""
    + ((stack1 = (helpers.ifCond || (depth0 && depth0.ifCond) || alias2).call(alias1,((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.right : stack1)) != null ? stack1.icon : stack1),"",{"name":"ifCond","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "")
    + "\" alt=\"\">\r\n      <div class=\"player__details\">\r\n        <div class=\"player__name\"><b>"
    + alias4(alias3(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.right : stack1)) != null ? stack1.name : stack1), depth0))
    + "</b></div>\r\n        <div class=\"player__badge\"><small>"
    + alias4(alias3(((stack1 = ((stack1 = (depth0 != null ? depth0.player : depth0)) != null ? stack1.right : stack1)) != null ? stack1.badge : stack1), depth0))
    + "</small></div>\r\n        <div class=\"player__score\"></div>\r\n      </div>\r\n\r\n  </div>\r\n</div>";
},"useData":true});
